...
enum CompanionBridgeGoalStatus: String, Codable, CaseIterable, Sendable {
    case active
    case paused
    case blocked
    case usageLimited
...
struct CompanionBridgeGoal: Codable, Equatable, Sendable {
    var threadID: String
    var objective: String
    var status: CompanionBridgeGoalStatus
    var tokenBudget: Int?
    var tokensUsed: Int
...
struct CompanionBridgeRequest: Codable, Equatable, Sendable {
    ...
    init(
        ...
        self.goalTokenBudget = goalTokenBudget
        self.text = text
        self.cwd = cwd
