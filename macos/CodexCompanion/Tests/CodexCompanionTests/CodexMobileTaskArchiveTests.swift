...
struct CodexMobileTaskArchiveTests {
    ...
    func taskPagePrefersTheSessionIndexConversationName() throws {
        ...
        try fixture.writeSessionName(
            id: "thread-renamed",
            name: "All in one Rhythm game 2"
        )

        let page = try CodexMobileTaskArchive(homeDirectory: fixture.root).tasks(cursor: nil, limit: 20)

        #expect(page.tasks.first?.title == "All in one Rhythm game 2")
    }
    ...
    func taskPageUsesSidebarTaskAndNamedProjectMetadata() throws {
        ...
        try fixture.insertThread(
            ...
            cwd: "/Example/Documents/Codex/2026-07-13/implementation"
        )
        try fixture.insertThread(
            id: "project-task",
            title: "Rhythm task",
            cwd: "/Example/Documents/Rhythm Game/work"
        )
        try fixture.writeSidebarState(
            pinnedThreadIDs: [],
            projectOrder: ["/Example/Documents/Rhythm Game"],
            projectlessThreadIDs: ["loose-task"],
            threadWorkspaceRootHints: [
                "loose-task": "/Example/Documents/Codex",
                "project-task": "/Example/Documents/Rhythm Game",
            ],
            workspaceRootLabels: [
                "/Example/Documents/Rhythm Game": "Mac Pulsefour (Main pulsefour)",
            ]
        )
        ...
        #expect(projectTask.taskGroup?.title == "Mac Pulsefour (Main pulsefour)")
        #expect(projectTask.taskGroup?.path == "/Example/Documents/Rhythm Game")
    }
    ...
    func taskPageMatchesPinnedThenProjectThenLooseChatOrdering() throws {
        ...
        try fixture.insertThread(
            id: "rhythm-task",
            title: "Rhythm task",
            cwd: "/Example/Documents/Rhythm Game",
            recency: 200
        )
        try fixture.insertThread(
            id: "pinned-old",
        ...
        #expect(page.tasks.map(\.id) == ["pinned-old", "rhythm-task", "loose-chat"])
    }
